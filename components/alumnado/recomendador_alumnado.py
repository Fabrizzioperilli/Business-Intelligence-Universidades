...
def recomendador_alumnado():
    return html.Div([
        ...
        html.Ul([
            html.Li(html.Span([html.Strong("Problemas económicos:"), " Muchos estudiantes abandonan la universidad por problemas económicos. La falta de "
            ...
            html.Li(html.Span([html.Strong("Problemas académicos:"), " Los problemas académicos también pueden ser una causa de deserción universitaria. "
            ...
            html.Li(html.Span([html.Strong("Problemas personales:"), " Los problemas personales, como la salud, la familia o las relaciones personales, pueden "
            ...
            html.Li(html.Span([html.Strong("Falta de motivación:"), " La falta de motivación es otra causa común de deserción universitaria. Los estudiantes que "
                    "no están motivados para estudiar pueden abandonar la universidad."]), className='li-recomendador-alumnado'),
            html.Li(html.Span([html.Strong("Falta de orientación:"), " La falta de orientación también puede ser una causa de deserción universitaria. Los estudiantes "
