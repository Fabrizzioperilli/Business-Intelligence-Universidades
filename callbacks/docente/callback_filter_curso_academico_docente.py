...
def update_filter_curso_academico_docente(docente_id, n_clicks, existing_options, last_clicked):
    ...
    if docente_id:
        # Lógica para actualizar basada en docente_id
        query = "SELECT curso_aca FROM docentes WHERE id_docente = :id_docente"
        result = db.execute_query(query, {'id_docente': docente_id})
