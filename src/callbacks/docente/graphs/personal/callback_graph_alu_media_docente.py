#
# @file callback_graph_alu_media_docente.py
# @brief Este fichero contiene el callback para actualizar el gráfico de evolución de la nota media por asignatura
