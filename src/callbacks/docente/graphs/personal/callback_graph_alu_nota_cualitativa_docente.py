#
# @file callback_graph_alu_nota_cualitativa_docente.py
# @brief Este fichero contiene el callback para actualizar el gráfico de evolución de calificaciones cualitativas
