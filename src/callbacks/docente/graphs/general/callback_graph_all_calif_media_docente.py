#
# @file callback_graph_all_calif_media_docente.py
# @brief Este fichero contiene el callback para actualizar el gráfico de nota media por asignatura de la titulación
